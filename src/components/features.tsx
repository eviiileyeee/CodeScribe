      ...
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>One-click conversion</CardTitle>
            <CardDescription>
              Convert your code between programming languages instantly with our AI-powered conversion engine.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Smart language detection</CardTitle>
            <CardDescription>
              Our system automatically detects your source code language and suggests the best target language for conversion.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
              Support for 20+ programming languages including Python, JavaScript, Java, C++, Go, Rust, and more.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>Code quality preservation</CardTitle>
            <CardDescription>
              Maintain code structure, comments, and formatting while ensuring the converted code follows best practices.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
